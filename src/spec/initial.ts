...
const initial: XenharmonicSeriesSpec = {
    ...
    [ XenharmonicSeriesSpecProperty.LOWER_BOUND ]: XENHARMONIC_SERIES_LOWER_BOUND,
    [ XenharmonicSeriesSpecProperty.POWER ]: to.Power(-1),
    ...
    [ XenharmonicSeriesSpecProperty.UPPER_BOUND ]: XENHARMONIC_SERIES_UPPER_BOUND,
