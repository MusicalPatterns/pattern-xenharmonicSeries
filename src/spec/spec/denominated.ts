...
const fiveDenominatedHarmonicSeries: XenharmonicSeriesSpecs = {
    ...
    [ XenharmonicSeriesSpec.UPPER_BOUND ]: as.Ordinal<XenharmonicSequence>(as.number(FIVE_DENOMINATOR)),
...
const sevenDenominatedHarmonicSeries: XenharmonicSeriesSpecs = {
    ...
    [ XenharmonicSeriesSpec.UPPER_BOUND ]: as.Ordinal<XenharmonicSequence>(as.number(SEVEN_DENOMINATOR)),
    [ XenharmonicSeriesSpec.ITERATIONS ]: XENHARMONIC_SERIES_STANDARD_ITERATIONS_WHEN_PRESENT,
}
...
const twelveDenominatedHarmonicSeries: XenharmonicSeriesSpecs = {
    ...
    [ XenharmonicSeriesSpec.UPPER_BOUND ]: as.Ordinal<XenharmonicSequence>(as.number(TWELVE_DENOMINATOR)),
    [ XenharmonicSeriesSpec.ITERATIONS ]: XENHARMONIC_SERIES_STANDARD_ITERATIONS_WHEN_PRESENT,
}
